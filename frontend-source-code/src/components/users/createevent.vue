<template>
  <v-main app>
    <div id="background">
      <div class="myform">
        <h2 class="input">Create Event</h2>
        <form @submit.prevent="onSubmit">
          ...
          <p id="error" v-if="$v.duration.$error">Please Enter Valid Number</p>
          <div class="input">
            <label for="studio">Studio</label>
            <input type="studio" id="studio" @blur="$v.studio.$touch()" v-model="studio" />
          </div>
          <div class="input">
